...
const NewsSection: FC = () => {
  return (
    <section className="relative bg-black text-white px-6 md:px-12 lg:px-20 py-20 overflow-hidden">
<div className=" absolute top-[610px] left-[74px] w-full h-[600px]">
 ...
 <div className="flex bg-black">
   ...
   <div className="h-[364px] w-[2px] bg-gradient-to-b from-orange-500 via-pink-500 to-purple-600"></div>
      ...
      {/* Gradient Glow Line */}
      <div className="absolute top-0 left-0 w-full h-[400px] overflow-hidden flex justify-center">
  <svg
    viewBox="0 0 800 200"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="w-[90%] h-full"  // <-- added gap by shrinking width
    preserveAspectRatio="none"
  >
    <defs>
      <linearGradient id="glow" x1="0" y1="0" x2="1" y2="0">
        <stop offset="0%" stopColor="#f97316" /> {/* orange-500 */}
        <stop offset="70%" stopColor="#f97316" /> {/* pink-500 */}
        <stop offset="100%" stopColor="#f97316" /> {/* purple-600 */}
      </linearGradient>
    </defs>

    {/* Multiple strokes for glow effect */}
    <path
      d="M0,150 C0,100 50,100 100,100 H700 C750,100 800,50 800,0"
      stroke="url(#glow)"
      strokeWidth="8"
      fill="none"
      strokeLinecap="round"
...
<div className="absolute top-28 right-[680px] w-full h-[500px] overflow-hidden flex justify-center">
        <svg
          viewBox="0 0 800 600"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Heading */}
      <div className="relative z-10 text-center mt-[300px] mb-16">
        <h2 className="text-3xl md:text-4xl font-['Satoshi'] font-bold">
          What’s New at Brand
        </h2>
      </div>
